...
public:
  ...
  bool get_peerlist_white(std::vector<PeerlistEntry>& pl_white) const;
  bool get_peerlist_gray(std::vector<PeerlistEntry>& pl_gray) const;
  bool get_peerlist_full(std::vector<PeerlistEntry>& pl_gray, std::vector<PeerlistEntry>& pl_white) const;
