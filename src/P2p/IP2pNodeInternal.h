...
public:
  ...
  virtual std::vector<PeerlistEntry> getLocalPeerList() const = 0;
  ...
  virtual bool handleRemotePeerList(const std::vector<PeerlistEntry>& peerlist, time_t local_time) = 0;
