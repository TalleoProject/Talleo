...
bool PeerlistManager::get_peerlist_white(std::vector<PeerlistEntry>& pl_white) const
{
...
bool PeerlistManager::get_peerlist_gray(std::vector<PeerlistEntry>& pl_gray) const
{
...
bool PeerlistManager::get_peerlist_full(std::vector<PeerlistEntry>& pl_gray, std::vector<PeerlistEntry>& pl_white) const
{
  const peers_indexed::index<by_time>::type& by_time_index_gr = m_peers_gray.get<by_time>();
  const peers_indexed::index<by_time>::type& by_time_index_wt = m_peers_white.get<by_time>();
